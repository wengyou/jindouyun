<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.id" clearable class="filter-item" style="width: 200px;" placeholder="请输入外卖商家ID" />
      <el-input v-model="listQuery.name" clearable class="filter-item" style="width: 200px;" placeholder="请输入外卖商家名称" />
...
<!--      <el-button v-permission="['POST /admin/brand/create']" class="filter-item" type="primary" icon="el-icon-edit" @click="handleCreate">添加</el-button>-->
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="外卖商家名称" prop="name" />

      <el-table-column align="center" property="picUrl" label="外卖商家图片">
      ...
      <el-table-column align="center" label="起送" prop="deliveryPrice" />
...
export default {
  ...
  computed: {
    headers() {
      return {
        'X-Jindouyun-Admin-Token': getToken()
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        const filterVal = ['id', 'name', 'desc', 'deliveryPrice', 'picUrl']
