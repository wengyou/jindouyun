<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.building" clearable class="filter-item" style="width: 200px;" placeholder="请输入楼栋号"/>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" min-width="100px" label="楼栋号" prop="building" />
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['地址ID', '用户ID', '收货人', '手机号','楼栋', '地址', '是否默认']
        const filterVal = ['id', 'userId', 'name', 'building', 'addressDetail', 'isDefault']
